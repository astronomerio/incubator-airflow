...
function highlightNodes(g, nodes, color, strokeWidth) {
...
function setUpNodeHighlighting(g, focusItem = null) {
  d3.selectAll('g.node').on('mouseover', function (d) {
    d3.select(this).selectAll('rect').style('stroke', highlightColor);
    highlightNodes(g, g.predecessors(d), upstreamColor, highlightStrokeWidth);
    highlightNodes(g, g.successors(d), downstreamColor, highlightStrokeWidth);
  ...
  d3.selectAll('g.node').on('mouseout', function (d) {
    ...
    highlightNodes(g, g.predecessors(d), null, initialStrokeWidth);
    highlightNodes(g, g.successors(d), null, initialStrokeWidth);
    d3.selectAll('g.node')
      .style('opacity', 1);
